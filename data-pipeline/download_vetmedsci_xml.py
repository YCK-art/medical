...
log_file = os.path.join(log_dir, 'vetmedsci_download.log')
...
def main():
    ...
    pmcid_file = '/Users/ksinfosys/Downloads/pmcid-VetMedSc.txt'

    # Output directory for XML files
    output_dir = '/Users/ksinfosys/medical/data-pipeline/guidelines/xml_vetmedsci'
