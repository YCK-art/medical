...
log_file = os.path.join(log_dir, 'actavet_download.log')
...
def main():
    ...
    pmcid_file = '/Users/ksinfosys/Downloads/pmcid-ActaVet.txt'

    # Output directory for XML files
    output_dir = '/Users/ksinfosys/medical/data-pipeline/guidelines/xml_actavet'
